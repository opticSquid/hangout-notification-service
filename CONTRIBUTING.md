# Contributing guidelines to Hangout Notification Service
...
5. **Commit Your Changes:** Commit your changes with a clear and concise commit message. Each commit message should describe what you changed and why. (e.g., "Fixed typo in documentation" or "Added support for feature Y").
